 ...
 * business; replace the whole object when a client supplies their details.
 */
export const site: SiteContent = {
  brand: {
    name: "زرنگار",
    latin: "ZARNEGAR",
    line: "کارگاه طلا و سنگ، با ساخت دست.",
  },
   ...
   */
  seo: {
    title: "زرنگار — کارگاه طلا و سنگ",
    titleTemplate: "%s — زرنگار",
    description:
      "زرنگار کارگاه کوچکی است برای ساخت دستی انگشتر، گردن‌آویز و گوشواره؛ نُه قطعه، هر کدام با سنگ و وزن مشخص خودش.",
    /**
    ...
    ogImage: {
      ...
      alt: "نشان زرنگار روی زمینهٔ شبق",
      width: 1200,
      height: 630,
    },
  },
   ...
   */
  nav: [
    { label: "قطعه‌ها", href: "/products/" },
    { label: "گالری", href: "/gallery/" },
    { label: "دربارهٔ ما", href: "/about/" },
    { label: "تماس با ما", href: "/about/#contact" },
  ],

  headerCta: { label: "سفارش و مشاوره", href: "/about/#contact" },
  ...
  contact: {
    ...
    email: "hello@zarnegar.example",
    /** Secondary inquiry path (§42), for brand-discovery rather than a piece-specific question. */
  ...
  copyright: "© ۱۴۰۵ زرنگار — تمام حقوق محفوظ است.",
};
